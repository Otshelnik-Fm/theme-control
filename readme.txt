...
<h3 style="color:#26901b;font-weight:bold;">"Шаблон готов для перевода? На какие языки он переведён?</h3>
- да. Вы можете перевести на нужный вам язык воспользовавшись любыми плагинами для интернационализации. Под вордпресс их много.

Доп переведён на английский и русский. 
Вы можете также перевести дополнение на свой язык через программу PoEdit и поделиться получившимся языковым файлом со мной.
Я его включу в обновление.
...
= 2021-03-20 =
v2.2.6
* потерянная кнопка "в черный список" вернулась на своё место (пропадала при включении дополнения Friends)
* перевод настроек дополнения на новое апи настроек WP-Recall
